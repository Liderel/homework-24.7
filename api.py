...
class PetFriends:
    ...
    def __init__(self):
        ...
        """Функция присваивает всем экземплярам класса 'PetFriends' базовый URL """

    # 24.4.1
    def get_api_key(self, email: str, password: str) -> json:
        """Функция делает запрос к API сервера и возвращает статус запроса и результат в формате
    ...
    def add_new_pet(self, auth_key: json, name: str, animal_type: str,
        ...
        """Функция отправляет (постит) на сервер данные о добавляемом питомце и возвращает статус
    ...
    def delete_pet(self, auth_key: json, pet_id: str) -> json:
        """Функция отправляет на сервер запрос на удаление питомца по указанному ID и возвращает
    ...
    def update_pet_info(self, auth_key: json, pet_id: str, name: str,
        ...
        """Функция отправляет запрос на сервер о обновлении данных питомуа по указанному ID и
